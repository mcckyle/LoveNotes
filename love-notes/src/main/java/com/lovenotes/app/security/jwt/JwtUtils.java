...
package com.lovenotes.app.security.jwt;
...
public class JwtUtils
{
                                   ...
                                   Collection<? extends GrantedAuthority> authorities)
    {
        ...
        return Jwts.builder()
                .setIssuer("love_notes_app")
                .setAudience("love_notes_app-client")
                .setId(jti)
    ...
    public Claims getClaimsFromToken(String token)
    {
        try
        {
            return Jwts.parserBuilder()
                    .requireIssuer("love_notes_app")
                    .requireAudience("love_notes_app-client")
